...
class Emergency():
    def email(username, humidity, temperature):
        mail = MIMEMultipart()
...
# <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
#   <img class="center fixedwidth" align="center" border="0" src="images/logo_icon_blue_268_198_280514.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 120px" width="120">
# <!--[if mso]></td></tr></table><![endif]-->
# </div>
...
# 		<div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Home Automation System<br></p></div>	
# 	</div>
# 	<!--[if mso]></td></tr></table><![endif]-->
# </div>
...
# 		<div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Temperature Reading: <br></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Humidity Reading:<br data-mce-bogus="1"></p></div>	
# 	</div>
# 	<!--[if mso]></td></tr></table><![endif]-->
# </div>
...
# </body></html>"""
        ...
        body = ("Emergency button was pressed at home by "+username+" at : " + str(timestamp) + '. Humidity is : {0:0.1f} %. Temperature is : {1:0.1f} C'.format(temperature,humidity))
